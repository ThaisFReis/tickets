...
**Branch**: `005-create-a-comprehensive` | **Date**: 2025-09-08 | **Spec**: [./spec.md](./spec.md)
**Input**: Feature specification from `/specs/005-create-a-comprehensive/spec.md`
...
**Storage**: Off-chain JSON for venue maps
**Testing**: Strict TDD
**Target Platform**: Web
...
```
specs/005-create-a-comprehensive/
